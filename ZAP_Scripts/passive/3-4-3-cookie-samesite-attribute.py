...
def scan(ps, msg, src):
  ...
  alertRisk= 0
  alertConfidence = 1
  alertTitle = "3.4.3 Verify that cookie-based session tokens utilize the 'SameSite' attribute to limit exposure to cross-site request forgery attacks."
  ...
  if ("samesite" not in headerCookie.lower()):
