"""
Credit to BlazingWind on Github for this script: https://github.com/BlazingWind/OWASP-ASVS-4.0-testing-guide/blob/main/ZAP-scripts/4-1-2-Hidden-fields.py
